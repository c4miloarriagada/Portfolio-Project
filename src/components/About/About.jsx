      ...
      <div> 
        ...
        <div className="col text-center text-white" >
         <div className="card bg-secondary container mt-1 animate__animated animate__fadeIn">
           ...
           Trabajé durante muchos años en el campo de la aviación como tripulante de cabina, también soy piloto comercial.<br/>
            Por lo mismo, desarrollé excelentes habilidades blandas y también entendí su importancia.<br/><br/>
            Comunicación ,
            trabajo en equipo, manejo y resolución de problemas, son algunas de mis características. Por ahora estoy buscando nuevos desafios en mi carrera profesional mientras me mantengo estudiando otras tecnologías, literalmente me enamoré del back end como también de TypeScript lo encuentro increíblemente bueno <br/>
            Pero no tengo problema en trabajar en front end con React Js o herramientas como redux o simplemente aprender otro framework, esta página la desarrolle con React y Bootstrap 5.
            <br/><br/>
            Sobre mí, soy un tipo tranquilo que realmente ama la música y la tecnología,en mi tiempo libre me gusta estudiar, tocar la guitarra , jugar algún videojuego o compartir con mis amigos y familia.<br/><br/>
